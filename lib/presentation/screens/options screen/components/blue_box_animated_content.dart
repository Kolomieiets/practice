...
class BlueBoxAnimatedContent extends StatelessWidget {
  ...
  BlueBoxAnimatedContent(
      {required this.percent, required this.size, super.key});

  @override
  Widget build(BuildContext context) {
    final double interpolatedImageSize = AppSizes.h35 + (percent * 30);
    ...
    final interpolatedPadding = EdgeInsets.lerp(
      EdgeInsets.only(
          ...
          bottom: AppSizes.h4),
      EdgeInsets.only(
          left: AppSizes.w16, right: AppSizes.w16, bottom: AppSizes.h16),
      percent,
    );
